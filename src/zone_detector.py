...
class ZoneDetector:
    ...
    def detect_hits(self, key_points: Dict, velocities: Dict) -> Set[str]:
        ...
        # Controlla i polsi (mani) per i colpi
        ...
        # Controlla i piedi (caviglie) per il kick
        for foot in ['left_ankle', 'right_ankle']:
            ...
            # Per il kick, controlla solo la zona kick
            if velocity >= self.velocity_threshold:
